...
function! s:GtagsCscope()
    ...
    if g:GtagsCscope_Auto_Map == 1
        if g:GtagsCscope_Use_Old_Key_Map == 1
            ...
            "
            " normal command
            :nmap <C-\>s :cs find s <C-R>=expand("<cword>")<CR><CR>zt
            :nmap <C-g> :cs find g <C-R>=expand("<cword>")<CR><CR>zt
            :nmap <C-\>c :cs find c <C-R>=expand("<cword>")<CR><CR>zt
            :nmap <C-\>t :cs find t <C-R>=expand("<cword>")<CR><CR>zt
            :nmap <C-\>e :cs find e <C-R>=expand("<cword>")<CR><CR>zt
            :nmap <C-\>f :cs find f <C-R>=expand("<cfile>")<CR><CR>zt
            :nmap <C-\>i :cs find i <C-R>=expand("<cfile>")<CR><CR>zt
